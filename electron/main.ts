...
import { resetClients as resetWorkflowClients } from "./workflow/services/service-locator";
...
interface Settings {
  apiKey: string;
  apiServiceId: "wavespeed" | "ideart-local" | "ideart-production" | "custom";
  apiBaseUrl: string;
...
ipcMain.handle("get-settings", () => {
  ...
  return {
    ...
    apiServiceId: settings.apiServiceId,
...
ipcMain.handle("set-settings", (_, newSettings: Partial<Settings>) => {
  ...
  if (
    "apiServiceId" in newSettings ||
    "apiBaseUrl" in newSettings ||
    "customApiBaseUrl" in newSettings
  ) {
    resetWorkflowClients();
  }
  return true;
