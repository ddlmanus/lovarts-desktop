...
const watermarkRemoverCover =
  "https://static.wavespeed.ai/static/2026-04-08/20260408110423_uvgdxblv.webp";
const videoWatermarkRemoverCover =
  "https://static.wavespeed.ai/static/2026-04-08/20260408111730_oggzfrzh.webp";
const videoEraserCover =
  "https://static.wavespeed.ai/static/2026-04-08/20260408111958_ymt9hd3r.webp";
const videoFpsIncreaserCover =
  "https://static.wavespeed.ai/static/2026-04-08/20260408110601_edivuv7f.webp";
...
export function FreeToolsPage() {
  ...
  const tools = [
    ...
    },
    {
      ...
      icon: Eraser,
      titleKey: "freeTools.videoWatermarkRemover.title",
      descriptionKey: "freeTools.videoWatermarkRemover.description",
      route: "/free-tools/video-watermark-remover",
      gradient: "from-teal-500/20 via-cyan-500/10 to-transparent",
      image: videoWatermarkRemoverCover,
      fallbackTitle: "Video Watermark Remover",
      fallbackDescription: "Remove watermarks, logos, and subtitles from video",
    },
    {
      id: "video-eraser",
      icon: Wand2,
      titleKey: "freeTools.videoEraser.title",
      descriptionKey: "freeTools.videoEraser.description",
      route: "/free-tools/video-eraser",
      gradient: "from-sky-500/20 via-emerald-500/10 to-transparent",
      image: videoEraserCover,
      fallbackTitle: "Video Eraser",
      fallbackDescription: "Remove unwanted objects or people from videos",
    },
    {
      id: "video-fps-increaser",
      icon: Zap,
      titleKey: "freeTools.videoFpsIncreaser.title",
      descriptionKey: "freeTools.videoFpsIncreaser.description",
      route: "/free-tools/video-fps-increaser",
      gradient: "from-yellow-500/20 via-cyan-500/10 to-transparent",
      image: videoFpsIncreaserCover,
      fallbackTitle: "Video FPS Increaser",
      fallbackDescription: "Double video frame rate for smoother motion",
    },
    {
      id: "image",
      icon: ImageUp,
    ...
    },
    {
      ...
      icon: Eraser,
      titleKey: "freeTools.watermarkRemover.title",
      descriptionKey: "freeTools.watermarkRemover.description",
      route: "/free-tools/image-watermark-remover",
      gradient: "from-lime-500/20 via-cyan-500/10 to-transparent",
      image: watermarkRemoverCover,
      fallbackTitle: "Image Watermark Remover",
      fallbackDescription: "Remove image watermarks with a dedicated AI model",
    },
    {
      id: "face-enhancer",
      icon: Sparkles,
