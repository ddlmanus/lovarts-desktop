...
import { MIN_TRANSFORM_SCALE } from "@/opencut-classic/animation/transform";
...
import { VOLUME_DB_MAX, VOLUME_DB_MIN } from "@/opencut-classic/timeline/audio-constants";
import {
	CORNER_RADIUS_MAX,
	CORNER_RADIUS_MIN,
} from "@/opencut-classic/text/background";
