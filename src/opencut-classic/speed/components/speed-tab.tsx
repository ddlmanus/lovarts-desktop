...
import type { AudioElement, VideoElement } from "@/opencut-classic/timeline";
import {
	Section,
	SectionContent,
	SectionField,
...
export function SpeedTab({
	...
	return (
		<Section collapsible sectionKey={`${element.id}:speed`}>
			<SectionHeader>
				<SectionTitle>{t("freeTools.mediaTrimmer.editor.speedPanel.title")}</SectionTitle>
			</SectionHeader>
			<SectionContent>
				<SectionFields>
					<SectionField label={t("freeTools.mediaTrimmer.editor.speedPanel.speed")}>
						<NumberField
					...
					<div className="flex items-center justify-between">
						<span className="text-sm">
							{t("freeTools.mediaTrimmer.editor.speedPanel.changePitch")}
						</span>
						<Switch
